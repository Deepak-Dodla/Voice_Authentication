...
def speaker_identifier():
    ...
    file = "Voice-Biometrics\data\Temp_Data\last_try.wav"
    ...
    df = pd.read_csv("Voice-Biometrics\data\Temp_Data\complete_data.csv")  # target variable is boolean : 1 means sahil, 0 means unknown
    Y = df["speaker"]
